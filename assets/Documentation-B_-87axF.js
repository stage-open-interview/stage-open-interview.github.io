import{r as h,j as e,X as I,Q as N,S as P,H as E,L as j,K as y,M as p,G as v,C as G,k as R,Z as g,N as S,F as T,J as C,g as B}from"./index-CQ_j5kne.js";import{E as Q}from"./EnhancedMermaid-CQfh3k13.js";import{D as L}from"./DesktopSidebarWrapper-DKlINkXS.js";import{M as F,F as A}from"./menu-D5fWVZFs.js";import{B as U}from"./target-RLcZqdrx.js";import{C as b}from"./UnifiedNav-CgbNa7H9.js";import{P as w}from"./zoom-out-CymIlzMJ.js";import{G as k}from"./globe-BjNmATLc.js";import{G as O}from"./tag-BD8YlMhR.js";import{E as H}from"./external-link-WaCEMDUI.js";import{C as _}from"./chevron-down-CsWY2JiW.js";import{C as V}from"./copy-DuTuLFu_.js";import"./UnifiedSearch-BBUc0DBS.js";import"./use-unified-toast-Bh56hcqt.js";import"./mic-B0FlmGCB.js";import"./user-XHKDxKpK.js";import"./chart-column-Cg6MV60z.js";const M=[{id:"overview",title:"Architecture Overview",icon:j,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:y,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:p,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:b,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:w,color:"#f778ba"},{id:"api",title:"API Reference",icon:v,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function ue(){const[s,i]=h.useState("overview"),[t,a]=h.useState(!1),[l,f]=h.useState("");return h.useEffect(()=>{a(!1)},[s]),e.jsx(L,{children:e.jsxs("div",{className:"min-h-screen bg-[#0d1117] text-[#e6edf3]",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-[#30363d] bg-[#0d1117]/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors",children:t?e.jsx(I,{className:"w-5 h-5"}):e.jsx(F,{className:"w-5 h-5"})}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(U,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-white",children:"Documentation"}),e.jsx("div",{className:"text-xs text-[#8b949e]",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(P,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:l,onChange:c=>f(c.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors",children:[e.jsx(E,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
