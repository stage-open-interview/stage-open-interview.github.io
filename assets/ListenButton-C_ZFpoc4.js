import{r as n,j as t}from"./index-C-IC1LIA.js";import{d as l,i as y,e as S,f as p}from"./text-to-speech-JKTbiyjG.js";import{L}from"./user-DzCJRC64.js";import{V as b}from"./volume-x-CjaNl4PZ.js";import{V as h}from"./volume-2-DR06x4Zp.js";function C({text:m,label:f="Listen",className:c="",size:a="md"}){const[s,e]=n.useState(!1),[o,r]=n.useState(!1),u=y();n.useEffect(()=>{const x=setInterval(()=>{!p()&&s&&e(!1)},100);return()=>clearInterval(x)},[s]),n.useEffect(()=>()=>{s&&l()},[s]);const d=()=>{s?(l(),e(!1)):(r(!0),S(m,{onStart:()=>{r(!1),e(!0)},onEnd:()=>{e(!1)},onError:()=>{r(!1),e(!1)}}),setTimeout(()=>{r(!1),p()&&e(!0)},500))};if(!u)return null;const g={sm:"px-2 py-1 text-xs gap-1",md:"px-3 py-1.5 text-sm gap-1.5",lg:"px-4 py-2 text-base gap-2"},i={sm:"w-3 h-3",md:"w-4 h-4",lg:"w-5 h-5"};return t.jsxs("button",{onClick:d,disabled:o,className:`
