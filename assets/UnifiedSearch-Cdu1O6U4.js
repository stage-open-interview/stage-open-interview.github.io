import{h as ce,aD as be,a7 as we,r as h,u as le,b as ue,j as e,l as V,m as A,X as I,S as O,Z as G,ai as ve}from"./index-Cn9kNtm6.js";import{u as de}from"./use-unified-toast-ath2zPeP.js";import{T as te,C as se,B as ne,G as re,F as pe}from"./tag-BRl1ewrE.js";import{T as K}from"./target-DZui4CLk.js";import{A as J}from"./arrow-right-CCY2gbfn.js";import{L as U}from"./loader-circle-DHgpCF8c.js";/**
 ...
 */const Ne=[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]],ie=ce("video",Ne),he=[{title:"Reverse a String",description:"Write a function that reverses a string. The input string is given as an array of characters.",difficulty:"easy",category:"strings",tags:["string","two-pointers","recursion"],starterCode:{javascript:`function reverseString(s) {
  ...
  return curr;
    ...
    for _ in range(3, n + 1):
        prev, curr = curr, prev + curr
    return curr`},complexity:{time:"O(n)",space:"O(1)",explanation:"We iterate from 3 to n once, using only two variables for state."},timeLimit:10}],Q="coding-challenge-progress";let R=null,B=null;async function fe(){return R||B||(B=(async()=>{try{const s=await fetch("/data/coding-challenges.json");if(!s.ok)throw new Error("Failed to load challenges");const o=(await s.json()).map(n=>({id:n.id,title:n.title,description:n.description,difficulty:n.difficulty,category:n.category,tags:n.tags||[],starterCode:n.starterCode||{javascript:"",python:""},testCases:(n.testCases||[]).map(i=>({id:i.id||String(Math.random()),input:i.input,expectedOutput:i.expectedOutput,isHidden:i.isHidden,description:i.description})),hints:n.hints||[],sampleSolution:n.solution||n.sampleSolution||{javascript:"",python:""},complexity:n.complexity||{time:"O(n)",space:"O(1)",explanation:""},timeLimit:n.timeLimit||15}));return R=o,o}catch(s){console.warn("Failed to load challenges from JSON, using fallback templates:",s);const r=he.map((o,n)=>({...o,id:`challenge-${n}`}));return R=r,r}})(),B)}function H(){return R||he.map((s,r)=>({...s,id:`challenge-${r}`}))}fe();function ke(s){const r=H();let o=r;return s&&(o=r.filter(n=>n.difficulty===s)),o[Math.floor(Math.random()*o.length)]}function xe(){return H()}async function Se(){return fe()}function Ce(s){return H().find(o=>o.id===s)||null}function ge(s,r,o){return o==="python"?r.testCases.map(n=>({testCaseId:n.id,passed:!1,error:"Use runTestsAsync for Python execution"})):r.testCases.map(n=>{try{return ze(s,n,r)}catch(i){return{testCaseId:n.id,passed:!1,error:i instanceof Error?i.message:"Execution error"}}})}function ae(s){try{return JSON.stringify(JSON.parse(s))}catch{return s}}async function Oe(s,r,o){if(o==="javascript")return ge(s,r,o);const{executePython:n,extractPythonFunctionName:i}=await be(async()=>{const{executePython:u,extractPythonFunctionName:p}=await import("./pyodide-runner-BcYiMYai.js");return{executePython:u,extractPythonFunctionName:p}},[]),c=i(r.starterCode.python);if(!c)return r.testCases.map(u=>({testCaseId:u.id,passed:!1,error:"Could not find function definition in code"}));const l=[];for(const u of r.testCases){const p=await n(s,c,u.input);if(p.success&&p.output){const f=p.output,m=ae(f),x=ae(u.expectedOutput),y=m===x;l.push({testCaseId:u.id,passed:y,actualOutput:f,executionTime:p.executionTime})}else l.push({testCaseId:u.id,passed:!1,error:p.error||"Execution failed",executionTime:p.executionTime})}return l}function ze(s,r,o){const n=performance.now();try{const i=o.starterCode.javascript.match(/function\s+(\w+)/),c=i?i[1]:"solution",l=`
      ${s}
      return ${c}(${r.input});
    `,p=new Function(l)(),f=performance.now()-n,m=JSON.stringify(p),x=r.expectedOutput,y=m===x;return{testCaseId:r.id,passed:y,actualOutput:m,executionTime:f}}catch(i){return{testCaseId:r.id,passed:!1,error:i instanceof Error?i.message:"Unknown error",executionTime:performance.now()-n}}}function _e(s){try{const r=localStorage.getItem(Q),o=r?JSON.parse(r):{attempts:[]};o.attempts.push(s),localStorage.setItem(Q,JSON.stringify(o))}catch{}}function X(){try{const s=localStorage.getItem(Q);return(s?JSON.parse(s):{attempts:[]}).attempts}catch{return[]}}function Te(){const s=X();return new Set(s.filter(r=>r.passed).map(r=>r.challengeId))}function qe(){const s=X(),r=s.filter(i=>i.passed),o=s.length>0?Math.round(s.reduce((i,c)=>i+c.timeSpent,0)/s.length):0,n={easy:{attempted:0,passed:0},medium:{attempted:0,passed:0}};return{totalAttempts:s.length,passedChallenges:r.length,averageTime:o,byDifficulty:n}}function Ee(s){const r=/for[\s\S]*for|while[\s\S]*while|for[\s\S]*while|while[\s\S]*for/.test(s),o=/function\s+(\w+)[\s\S]*\1\s*\(/.test(s),n=/Map|Set|Object|{}|\[\]/i.test(s),i=(s.match(/for|while/g)||[]).length;let c="O(1)",l="O(1)",u="Constant time and space operations.";return r?(c="O(n²)",u="Nested loops suggest quadratic time complexity."):i>0&&(c="O(n)",u="Single loop iteration through the input."),o&&(c=r?"O(2^n)":"O(n)",l="O(n)",u="Recursive calls add to the call stack."),n&&(l="O(n)",!r&&!o&&(u="Uses additional data structure for efficient lookups.")),{time:c,space:l,explanation:u}}const Ue=Object.freeze(Object.defineProperty({__proto__:null,analyzeCodeComplexity:Ee,getAllChallenges:xe,getAllChallengesAsync:Se,getChallengeAttempts:X,getChallengeById:Ce,getCodingStats:qe,getRandomChallenge:ke,getSolvedChallengeIds:Te,runTests:ge,runTestsAsync:Oe,saveChallengeAttempt:_e},Symbol.toStringTag,{value:"Module"}));function S(s,r){const o=s.toLowerCase(),n=r.toLowerCase();if(n===o)return 1e3;if(n.includes(o))return 500+(100-r.length);const i=o.split(/\s+/).filter(p=>p.length>1),c=n.split(/\s+/);let l=0,u=0;for(const p of i){let f=!1;for(const m of c){if(m===p){l+=50,f=!0;break}if(m.startsWith(p)){l+=30,f=!0;break}if(m.includes(p)){l+=15,f=!0;break}}f?(u++,l+=u*5):u=0}if(l===0&&o.length>=3){let p=0,f=-1;for(const m of o){const x=n.indexOf(m,f+1);x>-1&&(p+=1,x===f+1&&(p+=.5),f=x)}p>=o.length*.6&&(l=p)}return l}function Fe(s,r=20){if(!s||s.trim().length<2)return[];const o=we(),n=new Map,i=s.match(/^(?:tag:|#)(.+)$/i),c=!!i,l=c?i[1].trim():s;for(const p of o){const f=n.get(p.id),m=[];let x=0;if(c){const y=p.tags?.join(" ")||"",b=S(l,y);b>0&&(x+=b*10,m.push("tags"))}else{const y=S(l,p.question);y>0&&(x+=y*3,m.push("question"));const b=S(l,p.answer);b>0&&(x+=b*1.5,m.push("answer"));const N=p.tags?.join(" ")||"",z=S(l,N);z>0&&(x+=z*4,m.push("tags"));const w=`${p.channel} ${p.subChannel}`.replace(/-/g," "),k=S(l,w);k>0&&(x+=k*1.5,m.push("channel"))}x>0&&(!f||x>f.score)&&n.set(p.id,{question:p,score:x,matchedIn:m,type:"question"})}const u=Array.from(n.values());return u.sort((p,f)=>f.score-p.score),u.slice(0,r)}function Re(s,r=10){if(!s||s.trim().length<2)return[];const o=xe(),n=[];for(const i of o){const c=[];let l=0;const u=S(s,i.title);u>0&&(l+=u*3,c.push("title"));const p=S(s,i.description);p>0&&(l+=p*1.5,c.push("description"));const f=i.tags?.join(" ")||"",m=S(s,f);m>0&&(l+=m*2,c.push("tags"));const x=S(s,i.category.replace(/-/g," "));x>0&&(l+=x*1.5,c.push("category")),l>0&&n.push({challenge:i,score:l,matchedIn:c,type:"coding"})}return n.sort((i,c)=>c.score-i.score),n.slice(0,r)}function Ae(s,r=20){const o=Fe(s,r),n=Re(s,Math.floor(r/2)),i=[...o,...n];return i.sort((c,l)=>l.score-c.score),i.slice(0,r)}function ye(s,r){const[o,n]=h.useState(s);return h.useEffect(()=>{const i=setTimeout(()=>{n(s)},r);return()=>{clearTimeout(i)}},[s,r]),o}function C(s){return s.type==="question"}function W(s){return s.type==="coding"}function Ie({isOpen:s,onClose:r,initialQuery:o}){const[n,i]=h.useState(""),[c,l]=h.useState([]),[u,p]=h.useState([]),[f,m]=h.useState(0),[x,y]=h.useState(!1),[b,N]=h.useState("all"),z=h.useRef(null),w=h.useRef(null),[,k]=le(),{isSubscribed:Y,subscribeChannel:Z}=ue();de();const _=ye(n,150);h.useEffect(()=>{s&&o&&i(o)},[s,o]);const T=[{id:"all",label:"All",icon:e.jsx(me,{className:"w-3 h-3"})},{id:"tags",label:"Tags",icon:e.jsx(te,{className:"w-3 h-3"})},{id:"coding",label:"Coding",icon:e.jsx(se,{className:"w-3 h-3"})},{id:"company",label:"Company",icon:e.jsx(ne,{className:"w-3 h-3"})},{id:"video",label:"Video",icon:e.jsx(ie,{className:"w-3 h-3"})},{id:"diagram",label:"Diagram",icon:e.jsx(re,{className:"w-3 h-3"})}];h.useEffect(()=>{s&&(setTimeout(()=>{z.current?.focus(),w.current?.focus()},100),i(""),l([]),p([]),m(0),N("all"))},[s]),h.useEffect(()=>{if(_.length>=2){y(!0);const t=Ae(_,50);l(t),m(0),y(!1)}else l([])},[_]),h.useEffect(()=>{let t=c;switch(b){case"tags":t=c.filter(a=>C(a)&&a.matchedIn.includes("tags"));break;case"coding":t=c.filter(a=>W(a));break;case"company":t=c.filter(a=>C(a)&&a.question.companies&&a.question.companies.length>0);break;case"video":t=c.filter(a=>C(a)&&(a.question.videos?.shortVideo||a.question.videos?.longVideo));break;case"diagram":t=c.filter(a=>C(a)&&(a.question.diagram?.length??0)>20);break;default:t=c}p(t.slice(0,15)),m(0)},[c,b]);const D=h.useCallback(t=>{t.key==="ArrowDown"?(t.preventDefault(),m(a=>Math.min(a+1,u.length-1))):t.key==="ArrowUp"?(t.preventDefault(),m(a=>Math.max(a-1,0))):t.key==="Enter"&&u[f]?(t.preventDefault(),$(u[f])):t.key==="Escape"&&r()},[u,f,r]),$=t=>{if(W(t)){k(`/coding/${t.challenge.id}`),r();return}const{question:a}=t;k(`/channel/${a.channel}/${a.id}`),r()},ee=t=>{switch(t){case"beginner":return e.jsx(G,{className:"w-3 h-3 text-green-400"});case"intermediate":return e.jsx(K,{className:"w-3 h-3 text-yellow-400"});case"advanced":return e.jsx(pe,{className:"w-3 h-3 text-red-400"});default:return null}},E=t=>t==="all"?c.length:t==="tags"?c.filter(a=>C(a)&&a.matchedIn.includes("tags")).length:t==="coding"?c.filter(a=>W(a)).length:t==="company"?c.filter(a=>C(a)&&a.question.companies?.length).length:t==="video"?c.filter(a=>C(a)&&(a.question.videos?.shortVideo||a.question.videos?.longVideo)).length:t==="diagram"?c.filter(a=>C(a)&&(a.question.diagram?.length??0)>20).length:0,L=(t,a)=>{if(W(t))return e.jsxs("button",{onClick:()=>$(t),className:`w-full px-4 py-4 text-left flex items-start gap-3 transition-colors active:bg-primary/10 ${a===f?"bg-primary/20":"hover:bg-muted/50"}`,children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[t.challenge.difficulty==="easy"?e.jsx(G,{className:"w-3 h-3 text-green-400"}):e.jsx(K,{className:"w-3 h-3 text-yellow-400"}),e.jsxs("span",{className:"text-[10px] text-muted-foreground uppercase tracking-wider",children:["coding/",t.challenge.category]}),e.jsxs("span",{className:"flex items-center gap-0.5 text-[9px] text-purple-600 dark:text-purple-400 bg-purple-400/10 px-1.5 py-0.5 rounded ml-auto",children:[e.jsx(se,{className:"w-2.5 h-2.5"})," Challenge"]})]}),e.jsx("p",{className:"text-sm text-foreground line-clamp-2",children:t.challenge.title}),e.jsx("p",{className:"text-xs text-muted-foreground line-clamp-1 mt-1",children:t.challenge.description})]}),e.jsx(J,{className:`w-4 h-4 shrink-0 mt-1 ${a===f?"text-primary":"text-muted-foreground/30"}`})]},`coding-${t.challenge.id}-${a}`);const d=(t.question.companies?.length??0)>0,g=t.question.videos?.shortVideo||t.question.videos?.longVideo,j=(t.question.diagram?.length??0)>20;return e.jsxs("button",{onClick:()=>$(t),className:`w-full px-4 py-4 text-left flex items-start gap-3 transition-colors active:bg-primary/10 ${a===f?"bg-primary/20":"hover:bg-muted/50"}`,children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[ee(t.question.difficulty),e.jsxs("span",{className:"text-[10px] text-muted-foreground uppercase tracking-wider",children:[t.question.channel,"/",t.question.subChannel]}),e.jsxs("div",{className:"flex items-center gap-1 ml-auto",children:[d&&e.jsxs("span",{className:"flex items-center gap-0.5 text-[9px] text-blue-600 dark:text-blue-400 bg-blue-400/10 px-1.5 py-0.5 rounded",children:[e.jsx(ne,{className:"w-2.5 h-2.5"}),t.question.companies.length]}),g&&e.jsx("span",{className:"flex items-center text-[9px] text-red-600 dark:text-red-400 bg-red-400/10 px-1.5 py-0.5 rounded",children:e.jsx(ie,{className:"w-2.5 h-2.5"})}),j&&e.jsx("span",{className:"flex items-center text-[9px] text-green-600 dark:text-green-400 bg-green-400/10 px-1.5 py-0.5 rounded",children:e.jsx(re,{className:"w-2.5 h-2.5"})})]})]}),e.jsx("p",{className:"text-sm text-foreground line-clamp-2",children:t.question.question}),e.jsx("p",{className:"text-xs text-muted-foreground line-clamp-1 mt-1",children:t.question.answer}),t.question.tags?.length>0&&e.jsxs("div",{className:"flex items-center gap-1 mt-2 flex-wrap",children:[e.jsx(te,{className:"w-3 h-3 text-muted-foreground/50 shrink-0"}),t.question.tags.slice(0,5).map((q,F)=>e.jsx("span",{className:`text-[10px] px-1.5 py-0.5 rounded ${t.matchedIn.includes("tags")?"bg-primary/20 text-primary font-semibold border border-primary/30":"text-muted-foreground/70 bg-muted/50"}`,children:ve(q)},F)),t.question.tags.length>5&&e.jsxs("span",{className:"text-[10px] text-muted-foreground/50",children:["+",t.question.tags.length-5]})]})]}),e.jsx(J,{className:`w-4 h-4 shrink-0 mt-1 ${a===f?"text-primary":"text-muted-foreground/30"}`})]},`question-${t.question.id}-${a}`)},P=()=>e.jsxs("div",{className:"p-8 text-center text-muted-foreground",children:[e.jsx(O,{className:"w-12 h-12 mx-auto mb-4 opacity-30"}),e.jsx("p",{className:"text-base mb-1",children:"Type to search"}),e.jsx("p",{className:"text-sm opacity-70 mb-2",children:"Search questions, topics, or tags"}),e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-6 text-xs",children:[e.jsx("span",{className:"px-2 py-1 bg-primary/10 text-primary rounded font-mono",children:"tag:react"}),e.jsx("span",{className:"text-muted-foreground/50",children:"or"}),e.jsx("span",{className:"px-2 py-1 bg-primary/10 text-primary rounded font-mono",children:"#kubernetes"})]}),e.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:["react hooks","tag:system-design","#sql","kubernetes"].map(t=>e.jsx("button",{onClick:()=>i(t),className:"px-4 py-2 text-sm bg-muted hover:bg-muted/80 border border-border rounded-full transition-colors active:scale-95",children:t},t))})]}),M=()=>e.jsxs("div",{className:"p-8 text-center text-muted-foreground",children:[e.jsx(O,{className:"w-12 h-12 mx-auto mb-3 opacity-30"}),e.jsxs("p",{className:"text-base",children:['No results for "',n,'"']}),e.jsx("p",{className:"text-sm mt-2 opacity-70",children:"Try different keywords"})]});return s?e.jsx(V,{children:s&&e.jsxs(e.Fragment,{children:[e.jsxs(A.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"lg:hidden fixed inset-0 z-[200] bg-black/95 backdrop-blur-xl flex flex-col",style:{top:0,left:0,right:0,bottom:0,position:"fixed"},"data-testid":"search-modal-mobile",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 h-14 border-b border-white/10 flex-shrink-0",children:[e.jsx("h2",{className:"font-semibold text-lg text-white",children:"Search"}),e.jsx("button",{onClick:r,className:"p-2 -mr-2 hover:bg-white/10 rounded-xl transition-colors","data-testid":"search-close-btn",children:e.jsx(I,{className:"w-5 h-5 text-white/70"})})]}),e.jsx("div",{className:"px-4 py-3 flex-shrink-0",children:e.jsxs("div",{className:"flex items-center gap-3 px-4 py-3 bg-white/5 border border-white/10 rounded-2xl",children:[e.jsx(O,{className:"w-5 h-5 text-white/50 flex-shrink-0"}),e.jsx("input",{ref:w,type:"text",value:n,onChange:t=>i(t.target.value),onKeyDown:D,placeholder:"Search questions...",className:"flex-1 bg-transparent text-white text-base outline-none placeholder:text-white/30",autoComplete:"off",spellCheck:!1,"data-testid":"search-input-mobile"}),n&&e.jsx("button",{onClick:()=>i(""),className:"p-1.5 hover:bg-white/10 rounded-full flex-shrink-0",children:e.jsx(I,{className:"w-4 h-4 text-white/50"})})]})}),c.length>0&&e.jsx("div",{className:"flex items-center gap-2 px-4 py-2 overflow-x-auto no-scrollbar flex-shrink-0",children:T.map(t=>{const a=E(t.id);return e.jsxs("button",{onClick:()=>N(t.id),disabled:a===0&&t.id!=="all",className:`flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-full transition-all flex-shrink-0 ${b===t.id?"bg-primary text-white font-semibold":a>0?"bg-white/10 text-white/70":"bg-white/5 text-white/30"}`,children:[t.icon," ",t.label," (",a,")"]},t.id)})}),e.jsxs("div",{className:"flex-1 overflow-y-auto",children:[x&&e.jsx("div",{className:"p-8 text-center",children:e.jsx("div",{className:"w-6 h-6 border-2 border-primary/30 border-t-primary rounded-full animate-spin mx-auto"})}),!x&&n.length>=2&&u.length===0&&M(),!x&&u.length>0&&e.jsx("div",{className:"py-2",children:u.map((t,a)=>L(t,a))}),!x&&n.length<2&&P()]}),e.jsx("div",{className:"px-4 py-3 border-t border-white/10 flex-shrink-0",style:{paddingBottom:"max(env(safe-area-inset-bottom), 12px)"},children:e.jsx("p",{className:"text-sm text-white/40 text-center",children:u.length>0?`${u.length} results`:"Tap to search"})})]}),e.jsx(A.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"hidden lg:flex fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm items-start justify-center pt-[10vh] px-4",onClick:r,"data-testid":"search-modal-desktop",children:e.jsxs(A.div,{initial:{opacity:0,y:-20,scale:.95},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-20,scale:.95},className:"w-full max-w-2xl bg-card border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]",onClick:t=>t.stopPropagation(),children:[e.jsxs("div",{className:"flex items-center gap-3 p-4 border-b border-border",children:[e.jsx(O,{className:"w-5 h-5 text-muted-foreground"}),e.jsx("input",{ref:z,type:"text",value:n,onChange:t=>i(t.target.value),onKeyDown:D,placeholder:"Search questions, topics, tags...",className:"flex-1 bg-transparent text-foreground text-lg outline-none placeholder:text-muted-foreground/50",autoComplete:"off",spellCheck:!1,"data-testid":"search-input-desktop"}),n&&e.jsx("button",{onClick:()=>i(""),className:"p-1.5 hover:bg-muted rounded-full",children:e.jsx(I,{className:"w-4 h-4 text-muted-foreground"})}),e.jsx("kbd",{className:"px-2 py-1 text-[10px] text-muted-foreground bg-muted border border-border rounded",children:"ESC"})]}),c.length>0&&e.jsxs("div",{className:"flex items-center gap-2 px-4 py-2 border-b border-border bg-muted/30 flex-wrap",children:[e.jsx("span",{className:"text-[10px] text-muted-foreground uppercase tracking-wider mr-1",children:"Filter:"}),T.map(t=>{const a=E(t.id);return e.jsxs("button",{onClick:()=>N(t.id),disabled:a===0&&t.id!=="all",className:`flex items-center gap-1.5 px-2.5 py-1 text-[11px] rounded-full transition-all ${b===t.id?"bg-primary text-primary-foreground font-bold":a>0?"bg-muted text-muted-foreground hover:bg-muted/80":"bg-muted/50 text-muted-foreground/50 cursor-not-allowed"}`,children:[t.icon," ",t.label," ",e.jsxs("span",{className:"text-[9px] opacity-70",children:["(",a,")"]})]},t.id)})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto",children:[x&&e.jsx("div",{className:"p-8 text-center",children:e.jsx("div",{className:"w-6 h-6 border-2 border-primary/30 border-t-primary rounded-full animate-spin mx-auto"})}),!x&&n.length>=2&&u.length===0&&M(),!x&&u.length>0&&e.jsx("div",{className:"py-2",children:u.map((t,a)=>L(t,a))}),!x&&n.length<2&&P()]}),e.jsxs("div",{className:"px-4 py-3 border-t border-border flex items-center justify-between text-xs text-muted-foreground",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"↑↓"})," Navigate"]}),e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"↵"})," Select"]}),e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"ESC"})," Close"]})]}),u.length>0&&e.jsxs("span",{children:[u.length," results"]})]})]})})]})}):null}function Le({isOpen:s,onClose:r}){const[o,n]=h.useState(""),[i,c]=h.useState([]),[l,u]=h.useState(0),[p,f]=h.useState(!1),[m,x]=h.useState(!0),[y,b]=h.useState(null),[N,z]=h.useState({}),[w,k]=h.useState(null),[Y,Z]=h.useState(!1),_=h.useRef(null),T=h.useRef(null),[,D]=le(),{isSubscribed:$,subscribeChannel:ee}=ue();de();const E=ye(o,200);h.useEffect(()=>{const d=()=>Z(window.innerWidth<1024);return d(),window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),h.useEffect(()=>{async function d(){try{if(!document.querySelector('link[href*="pagefind"]')){const j=document.createElement("link");j.rel="stylesheet",j.href="/pagefind/pagefind-ui.css",document.head.appendChild(j)}if(!window.pagefind){await new Promise((q,F)=>{const v=document.createElement("script");v.src="/pagefind/pagefind.js",v.type="module",v.onload=()=>q(),v.onerror=()=>F(new Error("Failed to load Pagefind script")),document.head.appendChild(v)});let j=0;for(;!window.pagefind&&j<50;)await new Promise(q=>setTimeout(q,100)),j++}if(!window.pagefind)throw new Error("Pagefind not available");await window.pagefind.init(),T.current=window.pagefind;const g=await window.pagefind.filters();z(g),x(!1),b(null)}catch(g){console.error("Failed to load Pagefind:",g),b("Search index not available. Using fallback search."),x(!1)}}s&&!T.current&&d()},[s]),h.useEffect(()=>{s&&(setTimeout(()=>_.current?.focus(),100),n(""),c([]),u(0),k(null))},[s]),h.useEffect(()=>{async function d(){if(!T.current||E.length<2){c([]);return}f(!0);try{const g={};w&&(g.filters={difficulty:w});const j=await T.current.search(E,g),q=await Promise.all(j.results.slice(0,15).map(async F=>{const v=await F.data();return{id:v.meta.id||F.id,title:v.meta.title,excerpt:v.excerpt,channel:v.meta.channel||"",difficulty:v.meta.difficulty||"intermediate"}}));c(q),u(0)}catch(g){console.error("Search error:",g)}finally{f(!1)}}d()},[E,w]);const L=h.useCallback(d=>{d.key==="ArrowDown"?(d.preventDefault(),u(g=>Math.min(g+1,i.length-1))):d.key==="ArrowUp"?(d.preventDefault(),u(g=>Math.max(g-1,0))):d.key==="Enter"&&i[l]?(d.preventDefault(),P(i[l])):d.key==="Escape"&&r()},[i,l,r]),P=d=>{const g=d.channel;g&&D(`/channel/${g}/${d.id}`),r()},M=d=>{switch(d){case"beginner":return e.jsx(G,{className:"w-3 h-3 text-green-400"});case"intermediate":return e.jsx(K,{className:"w-3 h-3 text-yellow-400"});case"advanced":return e.jsx(pe,{className:"w-3 h-3 text-red-400"});default:return null}},t=()=>!N.difficulty||Object.keys(N.difficulty).length===0?null:e.jsxs("div",{className:`flex items-center gap-2 px-4 py-2 border-b border-border bg-muted/30 overflow-x-auto no-scrollbar flex-shrink-0 ${Y?"":"flex-wrap"}`,children:[!Y&&e.jsx("span",{className:"text-[10px] text-muted-foreground uppercase tracking-wider mr-1",children:"Difficulty:"}),e.jsxs("button",{onClick:()=>k(null),className:`flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-full transition-all flex-shrink-0 ${w?"bg-muted text-muted-foreground hover:bg-muted/80":"bg-primary text-primary-foreground font-semibold"}`,children:[e.jsx(me,{className:"w-3 h-3"})," All"]}),Object.entries(N.difficulty).map(([d,g])=>e.jsxs("button",{onClick:()=>k(w===d?null:d),className:`flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-full transition-all flex-shrink-0 ${w===d?"bg-primary text-primary-foreground font-semibold":"bg-muted text-muted-foreground hover:bg-muted/80"}`,children:[M(d)," ",d," (",g,")"]},d))]}),a=()=>e.jsxs("div",{className:"flex-1 overflow-y-auto",children:[p&&e.jsx("div",{className:"p-8 text-center",children:e.jsx(U,{className:"w-6 h-6 animate-spin mx-auto text-muted-foreground"})}),!p&&o.length>=2&&i.length===0&&e.jsxs("div",{className:"p-8 text-center text-muted-foreground",children:[e.jsx(O,{className:"w-12 h-12 mx-auto mb-3 opacity-30"}),e.jsxs("p",{className:"text-base",children:['No questions found for "',o,'"']}),e.jsx("p",{className:"text-sm mt-2 opacity-70",children:"Try different keywords"})]}),!p&&i.length>0&&e.jsx("div",{className:"py-2",children:i.map((d,g)=>e.jsxs("button",{onClick:()=>P(d),className:`w-full px-4 py-4 text-left flex items-start gap-3 transition-colors active:bg-primary/10 ${g===l?"bg-primary/20":"hover:bg-muted/50"}`,children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[M(d.difficulty),e.jsx("span",{className:"text-[10px] text-muted-foreground uppercase tracking-wider",children:d.channel})]}),e.jsx("p",{className:"text-sm text-foreground line-clamp-2",children:d.title}),e.jsx("p",{className:"text-xs text-muted-foreground line-clamp-2 mt-1",dangerouslySetInnerHTML:{__html:d.excerpt}})]}),e.jsx(J,{className:`w-4 h-4 shrink-0 mt-1 ${g===l?"text-primary":"text-muted-foreground/30"}`})]},d.id))}),!p&&o.length<2&&!m&&e.jsxs("div",{className:"p-8 text-center text-muted-foreground",children:[e.jsx(O,{className:"w-12 h-12 mx-auto mb-4 opacity-30"}),e.jsx("p",{className:"text-base mb-1",children:"Type at least 2 characters"}),e.jsx("p",{className:"text-sm opacity-70 mb-6",children:"Search questions, topics, or tags"}),e.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:["react hooks","system design","sql joins","kubernetes"].map(d=>e.jsx("button",{onClick:()=>n(d),className:"px-4 py-2 text-sm bg-muted hover:bg-muted/80 border border-border rounded-full transition-colors active:scale-95",children:d},d))})]})]});return s?Y?e.jsx(V,{children:e.jsxs(A.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"fixed inset-0 z-[200] bg-background flex flex-col","data-testid":"pagefind-search-mobile",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 h-14 border-b border-border bg-card flex-shrink-0 pt-safe",children:[e.jsx("h2",{className:"font-semibold text-lg",children:"Search"}),e.jsx("button",{onClick:r,className:"p-2 -mr-2 hover:bg-muted rounded-full","data-testid":"search-close-btn",children:e.jsx(I,{className:"w-5 h-5"})})]}),e.jsxs("div",{className:"flex items-center gap-3 px-4 py-3 border-b border-border bg-card flex-shrink-0",children:[m?e.jsx(U,{className:"w-5 h-5 text-muted-foreground animate-spin flex-shrink-0"}):e.jsx(O,{className:"w-5 h-5 text-muted-foreground flex-shrink-0"}),e.jsx("input",{ref:_,type:"text",value:o,onChange:d=>n(d.target.value),onKeyDown:L,placeholder:m?"Loading search...":"Search questions...",className:"flex-1 bg-transparent text-foreground text-base outline-none placeholder:text-muted-foreground/50",autoComplete:"off",spellCheck:!1,disabled:m,"data-testid":"search-input"}),o&&e.jsx("button",{onClick:()=>n(""),className:"p-1.5 hover:bg-muted rounded-full flex-shrink-0",children:e.jsx(I,{className:"w-4 h-4 text-muted-foreground"})})]}),y&&e.jsx("div",{className:"px-4 py-2 bg-yellow-500/10 border-b border-yellow-500/20 text-yellow-600 dark:text-yellow-400 text-xs flex-shrink-0",children:y}),t(),a(),e.jsx("div",{className:"px-4 py-3 border-t border-border bg-card flex-shrink-0",style:{paddingBottom:"max(env(safe-area-inset-bottom), 12px)"},children:e.jsx("p",{className:"text-sm text-muted-foreground text-center",children:i.length>0?`${i.length} result${i.length!==1?"s":""}`:"Tap to search"})})]})}):e.jsx(V,{children:e.jsx(A.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"fixed inset-0 z-[200] bg-background/80 backdrop-blur-sm flex items-start justify-center pt-[10vh] px-4",onClick:r,"data-testid":"pagefind-search-desktop",children:e.jsxs(A.div,{initial:{opacity:0,y:-20,scale:.95},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-20,scale:.95},className:"w-full max-w-2xl bg-card border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]",onClick:d=>d.stopPropagation(),children:[e.jsxs("div",{className:"flex items-center gap-3 p-4 border-b border-border",children:[m?e.jsx(U,{className:"w-5 h-5 text-muted-foreground animate-spin"}):e.jsx(O,{className:"w-5 h-5 text-muted-foreground"}),e.jsx("input",{ref:_,type:"text",value:o,onChange:d=>n(d.target.value),onKeyDown:L,placeholder:m?"Loading search...":"Search questions, topics, tags...",className:"flex-1 bg-transparent text-foreground text-lg outline-none placeholder:text-muted-foreground/50",autoComplete:"off",spellCheck:!1,disabled:m,"data-testid":"search-input"}),o&&e.jsx("button",{onClick:()=>n(""),className:"p-1.5 hover:bg-muted rounded-full",children:e.jsx(I,{className:"w-4 h-4 text-muted-foreground"})}),e.jsx("kbd",{className:"px-2 py-1 text-[10px] text-muted-foreground bg-muted border border-border rounded",children:"ESC"})]}),y&&e.jsx("div",{className:"px-4 py-2 bg-yellow-500/10 border-b border-yellow-500/20 text-yellow-600 dark:text-yellow-400 text-xs",children:y}),t(),a(),e.jsxs("div",{className:"px-4 py-3 border-t border-border flex items-center justify-between text-xs text-muted-foreground",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"↑↓"})," Navigate"]}),e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"↵"})," Select"]}),e.jsxs("span",{children:[e.jsx("kbd",{className:"px-1.5 py-0.5 bg-muted rounded text-[10px]",children:"ESC"})," Close"]})]}),i.length>0&&e.jsxs("span",{children:[i.length," result",i.length!==1?"s":""]})]})]})})}):null}const oe="search-provider";function Pe(){const[s,r]=h.useState(()=>typeof window>"u"?"fuzzy":localStorage.getItem(oe)||"fuzzy"),[o,n]=h.useState(!1);return h.useEffect(()=>{async function l(){try{const u=await fetch("/pagefind/pagefind.js",{method:"HEAD"});n(u.ok)}catch{n(!1)}}l()},[]),{provider:s==="pagefind"&&!o?"fuzzy":s,setProvider:l=>{r(l),localStorage.setItem(oe,l)},pagefindAvailable:o}}function Ve({isOpen:s,onClose:r,initialQuery:o}){const{provider:n}=Pe();return n==="pagefind"?e.jsx(Le,{isOpen:s,onClose:r}):e.jsx(Ie,{isOpen:s,onClose:r,initialQuery:o})}export{me as F,Ve as U,ie as V,qe as a,Ce as b,Ee as c,ke as d,xe as e,Ue as f,Te as g,Oe as r,_e as s};
