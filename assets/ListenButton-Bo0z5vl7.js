import{r as n,j as a}from"./index-EL3khofa.js";import{s as m,i as y,a as S,g as c}from"./text-to-speech-B4Hlh8Da.js";import{L as b}from"./loader-circle-Bp2Tb4dz.js";import{V as h}from"./volume-x-Cizn9o55.js";import{V as L}from"./volume-2-CAFsAquc.js";function N({text:f,label:u="Listen",className:i="",size:e="md"}){const[s,t]=n.useState(!1),[r,o]=n.useState(!1),d=y();n.useEffect(()=>{const x=setInterval(()=>{!c()&&s&&t(!1)},100);return()=>clearInterval(x)},[s]),n.useEffect(()=>()=>{s&&m()},[s]);const g=()=>{s?(m(),t(!1)):(o(!0),S(f,{onStart:()=>{o(!1),t(!0)},onEnd:()=>{t(!1)},onError:()=>{o(!1),t(!1)}}),setTimeout(()=>{o(!1),c()&&t(!0)},500))};if(!d)return null;const l={sm:"px-2 py-1 text-xs gap-1",md:"px-3 py-1.5 text-sm gap-1.5",lg:"px-4 py-2 text-base gap-2"},p={sm:"w-3 h-3",md:"w-4 h-4",lg:"w-5 h-5"};return a.jsxs("button",{onClick:g,disabled:r,className:`
