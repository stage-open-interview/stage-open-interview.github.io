import{r as h,j as e,X as D,L as N,S as P,H as E,e as G,d as R,Z as g,h as T}from"./index-Bcv0-f53.js";import{I as B}from"./InteractiveDiagram-HkudOaH-.js";import{A as Q,L as j,a as b}from"./AppLayout-Bej6Zn6f.js";import{S as L}from"./SEOHead-BrP3QeHb.js";import{M as F}from"./menu-2q2KJR54.js";import{B as O,a as y,G as U}from"./UnifiedSearch-w8cFWvhS.js";import{D as p,S as v,C as H}from"./server-DGRJhXqv.js";import{P as w}from"./zoom-out-D89TvjpU.js";import{G as S}from"./globe-CeBmO5rm.js";import{E as V}from"./external-link-DPBt8QWy.js";import{S as C}from"./shield-DKOqFPyt.js";import{F as A}from"./file-code-BITdPZN5.js";import{B as k}from"./box-CYavxOG-.js";import{C as _}from"./chevron-down-Cwv2YT_w.js";import{C as M}from"./copy-BiUWmCC2.js";import"./rotate-ccw-CvXv_WF3.js";import"./chevron-left-cPdxbJJk.js";import"./sun-DemIXw9j.js";import"./arrow-right-D-xChDue.js";import"./loader-circle-B5lw7S-_.js";const z=[{id:"overview",title:"Architecture Overview",icon:j,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:y,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:p,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:b,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:w,color:"#f778ba"},{id:"api",title:"API Reference",icon:v,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:S,color:"#d29922"}];function ye(){const[s,i]=h.useState("overview"),[t,a]=h.useState(!1),[l,u]=h.useState("");return h.useEffect(()=>{a(!1)},[s]),e.jsxs(Q,{fullWidth:!0,children:[e.jsx(L,{title:"Documentation | Code Reels",description:"Technical documentation, architecture overview, AI pipeline, API reference, and deployment guides for Code Reels."}),e.jsxs("div",{className:"min-h-screen bg-background text-foreground pt-14 lg:pt-0 overflow-x-hidden",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",children:t?e.jsx(D,{className:"w-5 h-5"}):e.jsx(F,{className:"w-5 h-5"})}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity duration-150 ease-out cursor-pointer",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(O,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-foreground",children:"Documentation"}),e.jsx("div",{className:"text-xs text-muted-foreground",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(P,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:l,onChange:c=>u(c.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(E,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
        ...
        `,children:e.jsxs("nav",{className:"p-4 space-y-1 overflow-y-auto h-full",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Documentation"}),z.map(c=>{const q=c.icon,f=s===c.id;return e.jsxs("button",{onClick:()=>i(c.id),className:`
