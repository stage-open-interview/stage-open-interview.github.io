import{r as n,j as a}from"./index-CkhVBA_0.js";import{d as m,i as y,e as S,f}from"./text-to-speech-JKTbiyjG.js";import{L as b}from"./loader-circle-DVhJr0QN.js";import{V as h}from"./volume-x-BjYtt9Si.js";import{V as L}from"./volume-2-DaascHTs.js";function N({text:c,label:u="Listen",className:i="",size:e="md"}){const[s,t]=n.useState(!1),[r,o]=n.useState(!1),d=y();n.useEffect(()=>{const x=setInterval(()=>{!f()&&s&&t(!1)},100);return()=>clearInterval(x)},[s]),n.useEffect(()=>()=>{s&&m()},[s]);const g=()=>{s?(m(),t(!1)):(o(!0),S(c,{onStart:()=>{o(!1),t(!0)},onEnd:()=>{t(!1)},onError:()=>{o(!1),t(!1)}}),setTimeout(()=>{o(!1),f()&&t(!0)},500))};if(!d)return null;const l={sm:"px-2 py-1 text-xs gap-1",md:"px-3 py-1.5 text-sm gap-1.5",lg:"px-4 py-2 text-base gap-2"},p={sm:"w-3 h-3",md:"w-4 h-4",lg:"w-5 h-5"};return a.jsxs("button",{onClick:g,disabled:r,className:`
