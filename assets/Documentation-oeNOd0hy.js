import{r as h,j as e,X as I,O as N,H as E,L as j,z as y,D as p,x as v,n as P,S as G,Z as g,E as S,w as R,y as C,g as T}from"./index-BEUcFgpc.js";import{E as B}from"./EnhancedMermaid-CFF6oVC0.js";import{D as Q}from"./DesktopSidebarWrapper-BGei78Z0.js";import{M as L,F as A}from"./menu-CW80nOFN.js";import{B as F}from"./target-BKH-G7uX.js";import{S as O}from"./UnifiedSearch-Dvtm1NQb.js";import{C as b}from"./UnifiedNav-DhMHub_m.js";import{P as w}from"./zoom-out-BBTzuWM3.js";import{G as k}from"./globe-CdApXqjq.js";import{G as U}from"./use-unified-toast-Zjyr3-X2.js";import{E as H}from"./external-link-Cupx0rY_.js";import{C as _}from"./chevron-down-BY2zvY37.js";import{C as V}from"./copy-A5P3VqBi.js";import"./mic-ByF8nX1L.js";import"./user-E8rCeIy3.js";import"./chevron-left-AFE3nbps.js";import"./chart-column-GyciAgOi.js";const M=[{id:"overview",title:"Architecture Overview",icon:j,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:y,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:p,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:b,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:w,color:"#f778ba"},{id:"api",title:"API Reference",icon:v,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function ue(){const[s,i]=h.useState("overview"),[t,a]=h.useState(!1),[l,f]=h.useState("");return h.useEffect(()=>{a(!1)},[s]),e.jsx(Q,{children:e.jsxs("div",{className:"min-h-screen bg-[#0d1117] text-[#e6edf3]",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-[#30363d] bg-[#0d1117]/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors",children:t?e.jsx(I,{className:"w-5 h-5"}):e.jsx(L,{className:"w-5 h-5"})}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(F,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-white",children:"Documentation"}),e.jsx("div",{className:"text-xs text-[#8b949e]",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(O,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:l,onChange:c=>f(c.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors",children:[e.jsx(E,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
