import{c as S,r as h,j as e,X as P,M as N,S as E,H as G,Z as g}from"./index-Bb5bc9Dq.js";import{bG as j,bF as R}from"./EnhancedMermaid-CeER_1_5.js";import{D as T}from"./DesktopSidebarWrapper-D7u10oHC.js";import{B,C as Q}from"./use-unified-toast-BEJqNzYt.js";import{L as y}from"./layers-BWEjwNVk.js";import{B as v,G as L}from"./use-focus-trap-B3UEM0WV.js";import{D as p,C as F}from"./database-B8q8ToRw.js";import{C as b}from"./UnifiedNav-D87q8tut.js";import{S as w}from"./server-QSUfYvjJ.js";import{G as C}from"./globe-DGBW4O4P.js";import{E as U}from"./external-link-CKrYzESY.js";import{S as O}from"./sparkles-5qaI5_ia.js";import{S as A}from"./shield-vNYatl_F.js";import{B as k}from"./box-A0LlkTp2.js";import{C as _}from"./chevron-down-Ck_u8-nu.js";import{C as H}from"./check-CFZdmRp5.js";import{C as V}from"./copy-CKeSW8Cr.js";import"./UnifiedSearch-BXjkTzZC.js";import"./chart-column-Bdvx6E9H.js";import"./user-B0PZynB9.js";/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=[["path",{d:"M10 12.5 8 15l2 2.5",key:"1tg20x"}],["path",{d:"m14 12.5 2 2.5-2 2.5",key:"yinavb"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z",key:"1mlx9k"}]],q=S("file-code",M);/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]],K=S("menu",z),$=[{id:"overview",title:"Architecture Overview",icon:y,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:v,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:p,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:b,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:j,color:"#f778ba"},{id:"api",title:"API Reference",icon:w,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:C,color:"#d29922"}];function we(){const[s,i]=h.useState("overview"),[t,a]=h.useState(!1),[l,f]=h.useState("");return h.useEffect(()=>{a(!1)},[s]),e.jsx(T,{children:e.jsxs("div",{className:"min-h-screen bg-[#0d1117] text-[#e6edf3]",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-[#30363d] bg-[#0d1117]/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors",children:t?e.jsx(P,{className:"w-5 h-5"}):e.jsx(K,{className:"w-5 h-5"})}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(B,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-white",children:"Documentation"}),e.jsx("div",{className:"text-xs text-[#8b949e]",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(E,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:l,onChange:c=>f(c.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(N,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors",children:[e.jsx(G,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
        ...
        `,children:e.jsxs("nav",{className:"p-4 space-y-1 overflow-y-auto h-full",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Documentation"}),$.map(c=>{const I=c.icon,u=s===c.id;return e.jsxs("button",{onClick:()=>i(c.id),className:`
                    w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all
                    ${u?"bg-[#21262d] text-white":"text-[#8b949e] hover:text-white hover:bg-[#161b22]"}
                  `,children:[e.jsx("div",{className:`p-1.5 rounded-md transition-colors ${u?"bg-[#30363d]":""}`,style:{color:u?c.color:void 0},children:e.jsx(I,{className:"w-4 h-4"})}),e.jsx("span",{className:"text-sm font-medium",children:c.title}),u&&e.jsx(Q,{className:"w-4 h-4 ml-auto text-[#6e7681]"})]},c.id)}),e.jsxs("div",{className:"pt-6 mt-6 border-t border-[#21262d]",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Quick Links"}),e.jsxs("a",{href:"https://github.com",target:"_blank",rel:"noopener",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors",children:[e.jsx(L,{className:"w-4 h-4"}),e.jsx("span",{children:"GitHub Repository"}),e.jsx(U,{className:"w-3 h-3 ml-auto"})]}),e.jsxs("a",{href:"/whats-new",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors",children:[e.jsx(O,{className:"w-4 h-4"}),e.jsx("span",{children:"What's New"})]})]})]})}),t&&e.jsx("div",{className:"fixed inset-0 bg-black/50 z-30 lg:hidden",onClick:()=>a(!1)}),e.jsx("main",{className:"flex-1 min-w-0 px-4 lg:px-8 py-8 lg:py-12",children:e.jsxs("div",{className:"max-w-4xl",children:[s==="overview"&&e.jsx(W,{}),s==="ai-pipeline"&&e.jsx(Y,{}),s==="database"&&e.jsx(J,{}),s==="frontend"&&e.jsx(Z,{}),s==="illustrations"&&e.jsx(X,{}),s==="api"&&e.jsx(ee,{}),s==="deployment"&&e.jsx(te,{})]})})]})]})})}function x({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"mb-10",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-3",children:[e.jsx("div",{className:"p-3 rounded-xl",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-7 h-7",style:{color:a}})}),e.jsx("div",{children:e.jsx("h1",{className:"text-2xl lg:text-3xl font-bold text-white",children:i})})]}),e.jsx("p",{className:"text-lg text-[#8b949e] leading-relaxed",children:t})]})}function r({code:s,language:i="typescript",title:t,copyable:a=!0}){const[l,f]=h.useState(!1),c=()=>{navigator.clipboard.writeText(s),f(!0),setTimeout(()=>f(!1),2e3)};return e.jsxs("div",{className:"rounded-xl overflow-hidden border border-[#30363d] my-6 group",children:[t&&e.jsxs("div",{className:"bg-[#161b22] px-4 py-2.5 border-b border-[#30363d] flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(q,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("span",{className:"text-sm text-[#8b949e] font-mono",children:t})]}),a&&e.jsx("button",{onClick:c,className:"p-1.5 hover:bg-[#30363d] rounded transition-colors",title:"Copy code",children:l?e.jsx(H,{className:"w-4 h-4 text-[#3fb950]"}):e.jsx(V,{className:"w-4 h-4 text-[#6e7681]"})})]}),e.jsx("pre",{className:"bg-[#0d1117] p-4 overflow-x-auto",children:e.jsx("code",{className:`language-${i} text-sm text-[#e6edf3] font-mono leading-relaxed`,children:s.trim()})})]})}function d({title:s,description:i,diagram:t}){const[a,l]=h.useState(!0);return e.jsxs("div",{className:"rounded-xl border border-[#30363d] bg-[#161b22]/50 overflow-hidden my-8",children:[e.jsxs("button",{onClick:()=>l(!a),className:"w-full p-4 flex items-center justify-between hover:bg-[#21262d]/50 transition-colors",children:[e.jsxs("div",{className:"text-left",children:[e.jsxs("h3",{className:"font-semibold text-white flex items-center gap-2",children:[e.jsx(k,{className:"w-4 h-4 text-[#58a6ff]"}),s]}),e.jsx("p",{className:"text-sm text-[#8b949e] mt-1",children:i})]}),e.jsx(_,{className:`w-5 h-5 text-[#6e7681] transition-transform ${a?"rotate-180":""}`})]}),a&&e.jsx("div",{className:"p-4 pt-0 border-t border-[#30363d]/50",children:e.jsx("div",{className:"bg-[#0d1117] rounded-lg p-4 overflow-x-auto",children:e.jsx(R,{chart:t})})})]})}function D({children:s}){return e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6",children:s})}function n({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"p-4 rounded-xl border border-[#30363d] bg-[#161b22]/30 hover:bg-[#161b22] hover:border-[#58a6ff]/30 transition-all group",children:[e.jsx("div",{className:"p-2 rounded-lg w-fit mb-3",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-5 h-5",style:{color:a}})}),e.jsx("h4",{className:"font-semibold text-white mb-1 group-hover:text-[#58a6ff] transition-colors",children:i}),e.jsx("p",{className:"text-sm text-[#8b949e] leading-relaxed",children:t})]})}function m({type:s="info",title:i,children:t}){const l={info:{bg:"bg-[#58a6ff]/10",border:"border-[#58a6ff]/30",icon:"💡",color:"text-[#58a6ff]"},warning:{bg:"bg-[#d29922]/10",border:"border-[#d29922]/30",icon:"⚠️",color:"text-[#d29922]"},success:{bg:"bg-[#3fb950]/10",border:"border-[#3fb950]/30",icon:"✅",color:"text-[#3fb950]"},tip:{bg:"bg-[#a371f7]/10",border:"border-[#a371f7]/30",icon:"🎯",color:"text-[#a371f7]"}}[s];return e.jsxs("div",{className:`${l.bg} ${l.border} border rounded-xl p-4 my-6`,children:[e.jsxs("div",{className:`font-semibold ${l.color} mb-2 flex items-center gap-2`,children:[e.jsx("span",{children:l.icon})," ",i]}),e.jsx("div",{className:"text-sm text-[#8b949e] leading-relaxed",children:t})]})}function o(){return e.jsx("hr",{className:"border-[#21262d] my-10"})}function W(){return e.jsxs("div",{children:[e.jsx(x,{icon:y,title:"Architecture Overview",description:"A modern full-stack application built with React, Express, and AI-powered content generation using LangGraph pipelines.",color:"#58a6ff"}),e.jsx(d,{title:"System Architecture",description:"High-level overview of the main components and their interactions",diagram:`
graph TB
...
}`}),e.jsx(m,{type:"warning",title:"Production Checklist",children:"Before deploying to production, ensure you have: configured all required environment variables, run database migrations, set up Qdrant collection with proper indexes, and tested the AI pipeline with your API keys."})]})}export{we as default};
