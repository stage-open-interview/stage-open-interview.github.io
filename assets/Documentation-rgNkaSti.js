...
}`}),e.jsx(m,{type:"warning",title:"Production Checklist",children:"Before deploying to production, ensure you have: configured all required environment variables, run database migrations, set up Qdrant collection with proper indexes, and tested the AI pipeline with your API keys."})]})}export{je as default};
